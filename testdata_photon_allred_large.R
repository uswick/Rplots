...
Titl="Allreduce large message (64K) performance on `Cutter` (iterations = 1000)"
X_LABEL="nodes (count)"
Y_LABEL="time (us)"
...
mydata <- read.csv("/Users/udayangawickramasinghe/Documents/Collectives/photon/microallreduce_large_64K_cutter.csv", header = TRUE)
