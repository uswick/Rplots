...
###########PARAMS#############
T="Scaling Performance Lullesh (with/without tbbmalloc) on `Edison` [x = 48]"
...
ser_labels=c()
ser_labels[1]="mpi"
ser_labels[2]="isir new collective"
ser_labels[3]="isir new collective tbbmalloc"
ser_labels[4]="isir parcel tbbmalloc"
ser_labels[5]="pwc parcel tbbmalloc"
