...
g_range <- range(0, mydata[,2], mydata[,3])
View(mydata)
plot.new()
...
# the actual plots 
legend(LEGEND_X_POS, g_range[2], c(SERIES_1,SERIES_2), cex=LBL_FONT_SZ, 
       col=c(SERIES_1.COLOR,SERIES_2.COLOR), pch=21:22, lty=1:2);
