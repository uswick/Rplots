...
lines(mydata[,1],mydata[,5], type="o", col=SERIES_4.COLOR, lwd=1, pch= 24, lty=2)

# Create a legend at (1, g_range[2]) that is slightly smaller 
# (cex) and uses the same line colors and points used by 
# the actual plots 
legend(LEGEND_X_POS, g_range[2], c(SERIES_1,SERIES_2, SERIES_3, SERIES_4), cex=LBL_FONT_SZ, 
       col=c(SERIES_1.COLOR,SERIES_2.COLOR, SERIES_3.COLOR, SERIES_4.COLOR), pch=21:24, lty=c(1,2,2));
