...
###########PARAMS#############
T="Scaling Performance Lullesh (with/without jemalloc) on `Edison` [x = 32]"
...
ser_labels=c()
ser_labels[1]="mpi"
ser_labels[2]="pwc parcel jemalloc"
ser_labels[3]="isir new collective jemalloc"
ser_labels[4]="isir parcel jemalloc"
ser_labels[5]="pwc parcel"
ser_labels[6]="isir new collective"
ser_labels[7]="isir parcel"
