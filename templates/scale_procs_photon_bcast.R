...
mydata <- read.csv("/Users/udayangawickramasinghe/Desktop/Summer2016/quals/Q_Andrew/paper/data_photon_performance/cutter/x_procs_y_time_photon_latency/excel/bcast.csv", header = TRUE)
...
MYPLOT_PROPS['axis.range.y.limit', 'b']=155
...
dataset1
myplot2(dataset1, "procs", "time", "mode", "ci", "Broadcast Small Message (4byte) Latency on Photon, LibNBC (OFED) and MPI (cutter/224 cores)")

savelast_plot(name="bcast_4_final")
