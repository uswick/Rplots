...
Titl="Allreduce performance on `Cutter` (iterations = 1000)"
X_LABEL="nodes (count)"
Y_LABEL="time (us)"
...
mydata <- read.csv("/Users/udayangawickramasinghe/Documents/Collectives/photon/microallreduce_cutter.csv", header = TRUE)
