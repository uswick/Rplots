...
Titl="Barrier performance on `Cutter` (iterations = 1000)"
X_LABEL="nodes (count)"
Y_LABEL="time (us)"
LEGEND_POS=c(0.23,0.9)
SERIES_COLORS=c("blue","chartreuse4","red","purple","violet")
SERIES_FILL_COLORS=c("white","green", "red", "white", "white")
SERIES_MARKERS=c(24,21,22,23,25)
LEGEND_POS=c(0.12,0.87)
...
mydata <- read.csv("/Users/udayangawickramasinghe/Documents/Collectives/photon/microbarrier_cutter.csv", header = TRUE)
